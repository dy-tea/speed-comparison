...
v:
  ...
  RUN git clone --depth 1 --branch $(git ls-remote --tags --sort="v:refname" https://github.com/vlang/v.git | tail -n1 | sed 's/.*\///; s/\^{}//') --single-branch https://github.com/vlang/v.git /opt/vlang && \
